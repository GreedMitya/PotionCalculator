...
- Подгрузка цен ингредиентов и продажной цены через API с официального сервера
- Расчёт стоимости крафта, налога и итоговой прибыли
- Подсветка незаполненных полей
- Экран "Избранное" с сохранёнными рецептами
