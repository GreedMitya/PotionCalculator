...
class CraftViewModel : ViewModel() {
    ...
    val allPotions = listOf(
        ...
        PotionInfo("Berserker Potion", "POTION_BERSERK", listOf("T4", "T6", "T8")),
        PotionInfo("Calming Potion", "POTION_COOLDOWN", listOf("T3", "T5", "T7")),
        PotionInfo("Cleansing Potion", "POTION_CLEANSE", listOf("T3", "T5", "T7")),
        PotionInfo("Energy Potion", "POTION_ENERGY", listOf("T2", "T4", "T6")),
        PotionInfo("Gigantify Potion", "POTION_GIANT", listOf("T3", "T5", "T7")),
        PotionInfo("Healing Potion", "POTION_HEAL", listOf("T2", "T4", "T6")),
        PotionInfo("Hellfire Potion", "POTION_HELL", listOf("T4", "T6", "T8")),
        PotionInfo("Invisibility Potion", "POTION_INVISIBILITY", listOf("T8")),
        PotionInfo("Resistance Potion", "POTION_RESISTANCE", listOf("T3", "T5", "T7")),
        PotionInfo("Poison Potion", "POTION_SLOWFIELD", listOf("T4", "T6", "T8")),
        PotionInfo("Sticky Potion", "POTION_STICKY", listOf("T3", "T5", "T7")),
