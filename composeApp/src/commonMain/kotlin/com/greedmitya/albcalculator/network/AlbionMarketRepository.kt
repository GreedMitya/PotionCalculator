...
interface AlbionMarketRepository {
    suspend fun getPrices(itemIds: List<String>, city: String, serverCode: String): ApiResult<List<MarketItemPrice>>
}

class AlbionMarketRepositoryImpl(private val httpClient: HttpClient) : AlbionMarketRepository {
    private val json = Json { ignoreUnknownKeys = true }

    override suspend fun getPrices(itemIds: List<String>, city: String, serverCode: String): ApiResult<List<MarketItemPrice>> {
